 ...
 */
final class Version20210623122514 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prix_inter_produit (prix_inter_id INT NOT NULL, produit_id INT NOT NULL, INDEX IDX_9521572D936789EC (prix_inter_id), INDEX IDX_9521572DF347EFB (produit_id), PRIMARY KEY(prix_inter_id, produit_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
